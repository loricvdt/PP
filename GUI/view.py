...
def initialise():
	...
	V_0_slider = tk.Scale(left_frame, from_=maths.E_min, to=maths.E_max, resolution=0.01, orient=tk.HORIZONTAL, length=200, label="Initial potential (eV)", showvalue=0, command=controller.update_v_0)
